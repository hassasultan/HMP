                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="link" class="form-control border p-2">
                                        <option disabled selected>-- Select Option --</option>
                                        <option @if(request()->has('link') && request()->get('link') == 1) selected @endif value="1">Yes</option>
                                        <option @if(request()->has('link') && request()->get('link') == 1) selected @endif value="0">No</option>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="status" class="form-control border p-2">
                                        <option disabled selected>-- Select Option --</option>
                                        <option @if(request()->has('status') && request()->get('status') == 1) selected @endif value="1">Active</option>
                                        <option @if(request()->has('status') && request()->get('status') == 0) selected @endif value="0">DeActive</option>
                                    </select>
                                </div>
                                <div class="col-md-1">
                                    <br />
