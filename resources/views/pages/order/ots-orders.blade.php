    ...
    <div class="row">
        <div class="col-12">
            <div class="card my-4">
                                ...
                                @if (count($orders) > 0)
                                    ...
                                    <img src="{{ asset('storage/'.$row->image) }}" class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        ...
                                                        <p>Order Id:</p>
                                                        <p class="text-xs text-secondary mb-0">{{ $row['order_id'] }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                <p class="text-xs text-primary mb-0">{{ $row['consumer_address']['label'] }}
                                                </p>
                                            ...
                                            <td>
                                                <p class="text-center font-weight-bold mb-0">{{ $row['hydrant']['title'] }}
                                                </p>
                                            </td>
                                            <td>
                ...
                <div class="d-flex justify-content-center villa-listing-pagination">
                    {{  $orders->links() }}
                </div>
